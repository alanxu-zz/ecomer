...
import me.alanx.ecomer.core.model.order.*;
...
import me.alanx.ecomer.core.repositories.order.OrderRepository;
...
import me.alanx.ecomer.core.services.order.ordertotal.OrderTotalService;
...
public class OrderServiceImpl  extends SalesManagerEntityServiceImpl<Long, Order> implements OrderService {
    ...
    @Inject
    private InvoiceService invoiceModule;
