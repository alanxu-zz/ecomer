...
import me.alanx.ecomer.core.repositories.catalog.product.ProductRepository;
import me.alanx.ecomer.core.services.catalog.CatalogServiceHelper;
...
public class ProductServiceImpl extends SalesManagerEntityServiceImpl<Long, Product> implements ProductService {
	...
	@Inject
	ProductOptionPriceService productOptionPriceService;
