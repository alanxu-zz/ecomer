...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query("select u from User as u inner join fetch u.groups ug inner join fetch u.merchantStore um left join fetch u.defaultLanguage ul where u.username = ?1")
