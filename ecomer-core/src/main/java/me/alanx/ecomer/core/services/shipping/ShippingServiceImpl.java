...
import me.alanx.ecomer.core.constants.ShippingConstants;
...
import me.alanx.ecomer.core.model.shipping.*;
import me.alanx.ecomer.core.model.shoppingcart.ShoppingCartItem;
import me.alanx.ecomer.core.model.system.*;
...
import me.alanx.ecomer.core.services.system.MerchantLogService;
...
public class ShippingServiceImpl implements ShippingService {
	...
	public CustomIntegrationConfiguration getCustomShippingConfiguration(String moduleCode, MerchantStore store) throws ServiceException {
		...
		if (this.shippingModules == null) {
			LOGGER.warn("No shipping modules find");
			return null;
		}
	...
	public List<PackageDetails> getPackagesDetails(
		...
		if (this.packaging == null) {
			throw new IllegalStateException("No Packaing found.");
		}
