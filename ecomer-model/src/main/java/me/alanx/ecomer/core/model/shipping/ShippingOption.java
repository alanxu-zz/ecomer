package me.alanx.ecomer.core.model.shipping;
...
import me.alanx.ecomer.core.model.exception.JsonifyException;
	...
	public BigDecimal getOptionPrice() {
		...
		if(!StringUtils.isBlank(this.getOptionPriceText())) {
			try {
				...
				throw new JsonifyException("Can't convert price text " + this.getOptionPriceText() + " to big decimal", e);
			}
		}
