...
public class Product extends AuditableEntity<Long, Product> implements Auditable {
	...
	@OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL, mappedBy = "product")
	private Set<ProductOptionPrice> options = new HashSet<ProductOptionPrice>();
	...
	@OneToMany(fetch = FetchType.LAZY, 
			...
			orphanRemoval = true, 
			mappedBy = "product")
	@FilterCandidate(by = "attribute.name", type = FilterValueType.STRING)
	private Collection<ProductAttributeItem> attributes = new HashSet<>();
	...
	public Set<ProductOptionPrice> getOptions() {
		return options;
	}

	public void setOptions(Set<ProductOptionPrice> attributes) {
	 ...
	 */
	public Collection<ProductAttributeItem> getAttributes() {
		return attributes;
	}
	
	public void addAttribute(ProductAttributeItem attribute) {
