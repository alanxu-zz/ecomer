 ...
 */
public abstract class ApplicationEntity<K extends Serializable & Comparable<K>, E extends ApplicationEntity<K, ?>>
	...
	public boolean equals(Object object) {
		...
		ApplicationEntity<K, E> entity = (ApplicationEntity<K, E>) object; // NOSONAR : traité au-dessus mais wrapper Hibernate 
		K id = getId();
