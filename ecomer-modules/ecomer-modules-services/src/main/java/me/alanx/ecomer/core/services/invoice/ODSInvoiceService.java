...
import me.alanx.ecomer.core.services.invoice.ODSInvoiceService;
...
import me.alanx.ecomer.core.utils.ProductUtils;




@Service
public class ODSInvoiceService implements InvoiceService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger( ODSInvoiceService.class );
	...
	public ByteArrayOutputStream createInvoice(MerchantStore store, Order order, Language language) throws Exception {
			...
			for(OrderProduct orderProduct : orderProducts) {
				...
				String t = ProductPriceUtils.getStoreFormatedAmountWithCurrency(store, ProductPriceUtils.getOrderProductTotalPrice(store, orderProduct));
