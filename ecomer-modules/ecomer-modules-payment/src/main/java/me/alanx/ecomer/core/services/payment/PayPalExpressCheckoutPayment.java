...
@Service
public class PayPalExpressCheckoutPayment extends ModularizedPaymentService {
	
	public PayPalExpressCheckoutPayment() {
		super(PaymentType.PAYPAL.getPaymentName());
	}
	...
	public Transaction authorize(MerchantStore store, Customer customer,
		...
		me.alanx.ecomer.core.model.payments.PaypalPayment paypalPayment = (me.alanx.ecomer.core.model.payments.PaypalPayment)payment;
	...
	public Transaction initPaypalTransaction(MerchantStore store,
		...
		try {
			...
			StringBuilder RETURN_URL = new StringBuilder().append(
					env.getProperty("SHOP_SCHEME", "http")).append("://")
					.append(store.getDomainName()).append("/")
					.append(env.getProperty("CONTEXT_PATH", "sm-shop"));
					


			SetExpressCheckoutRequestDetailsType setExpressCheckoutRequestDetails = new SetExpressCheckoutRequestDetailsType();
			String returnUrl = RETURN_URL.toString() + new StringBuilder().append(Constants.SHOP_URI).append("/paypal/checkout").append(env.getProperty("URL_EXTENSION", ".html")).append("/success").toString();
			String cancelUrl = RETURN_URL.toString() + new StringBuilder().append(Constants.SHOP_URI).append("/paypal/checkout").append(env.getProperty("URL_EXTENSION", ".html")).append("/cancel").toString();
