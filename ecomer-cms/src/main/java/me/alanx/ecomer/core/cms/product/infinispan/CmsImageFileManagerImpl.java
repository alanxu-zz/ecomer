package me.alanx.ecomer.core.cms.product.infinispan;
...
import me.alanx.ecomer.core.cms.cache.CacheManager;
import me.alanx.ecomer.core.cms.product.ProductImageGet;
import me.alanx.ecomer.core.cms.product.ProductImagePut;
import me.alanx.ecomer.core.cms.product.ProductImageRemove;
    ...
    implements ProductImagePut, ProductImageGet, ProductImageRemove
{
    ...
    private static volatile CmsImageFileManagerImpl fileManager = null;
    ...
    // Lazy singleton pattern - double check with volatile
    public static CmsImageFileManagerImpl getInstance() {

        if (fileManager == null) {
        	synchronized(CmsImageFileManagerImpl.class) {
        		if(fileManager == null) {
