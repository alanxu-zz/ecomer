...
import me.alanx.ecomer.web.admin.controller.customers.CustomerController;
...
public class ManufacturerController {
	...
	private String displayManufacturer(Long manufacturerId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		me.alanx.ecomer.web.dto.admin.catalog.Manufacturer manufacturer = new me.alanx.ecomer.web.dto.admin.catalog.Manufacturer();
	...
	public String saveManufacturer( @Valid @ModelAttribute("manufacturer") me.alanx.ecomer.web.dto.admin.catalog.Manufacturer manufacturer, BindingResult result, Model model,  HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
	...
	//validate image
		if(manufacturer.getImage()!=null && !manufacturer.getImage().isEmpty()) {
			...
			try {
				...
				String maxHeight = env.getProperty("PRODUCT_IMAGE_MAX_HEIGHT_SIZE");
				String maxWidth = env.getProperty("PRODUCT_IMAGE_MAX_WIDTH_SIZE");
				String maxSize = env.getProperty("PRODUCT_IMAGE_MAX_SIZE");
