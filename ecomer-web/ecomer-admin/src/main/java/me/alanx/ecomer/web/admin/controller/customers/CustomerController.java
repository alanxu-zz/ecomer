package me.alanx.ecomer.web.admin.controller.customers;
	...
	public @ResponseBody ResponseEntity<String> saveCustomerAttributes(HttpServletRequest request, Locale locale) throws Exception {
		...
		while(parameterNames.hasMoreElements()) {
			...
			try {
				...
				me.alanx.ecomer.core.model.customer.attribute.CustomerOption customerOption = null;
				me.alanx.ecomer.core.model.customer.attribute.CustomerOptionValue customerOptionValue = null;
