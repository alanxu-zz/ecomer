				...
				<h3>
					<c:choose>
						<c:when test="${user.id!=null && user.id>0}">
								<s:message code="label.user.edituser" text="Edit user" /> <c:out value="${user.username}"/>
						</c:when>
						<c:otherwise>
				...
				<form:form method="POST" commandName="user" action="${userSave}">
                  ...
                  <div class="control-group">
                        <label><s:message code="label.user.name" text="User name"/></label>
	                        <div class="controls">
	                        		<form:input cssClass="input-large highlight" path="username" onblur="validateCode()"/>
	                                <span class="help-inline"><div id="checkCodeStatus" style="display:none;"></div><form:errors path="username" cssClass="error" /></span>
	                        </div>
                  </div>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                          <form:select cssClass="" items="${questions}" itemValue="question.id" itemLabel="label" path="securityAnswers[0].question.id"/>
                          <form:input cssClass="input-large" path="securityAnswers[0].answer"/>
                              <span class="help-inline"><form:errors path="securityAnswers[0].answer" cssClass="error" /></span>
                      </div>
                  </div>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                      	  <form:select cssClass="" items="${questions}" itemValue="question.id" itemLabel="label" path="securityAnswers[1].question.id"/>
                          <form:input cssClass="input-large" path="securityAnswers[1].answer"/>
                              <span class="help-inline"><form:errors path="securityAnswers[1].answer" cssClass="error" /></span>
                      </div>
                  </div>
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                      	  <form:select cssClass="" items="${questions}" itemValue="question.id" itemLabel="label" path="securityAnswers[2].question.id"/>
                          <form:input cssClass="input-large" path="securityAnswers[2].answer"/>
                              <span class="help-inline"><form:errors path="securityAnswers[2].answer" cssClass="error" /></span>
                      </div>
                  </div>
