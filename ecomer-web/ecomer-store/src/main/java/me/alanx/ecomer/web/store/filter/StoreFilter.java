package me.alanx.ecomer.web.store.filter;
...
import me.alanx.ecomer.web.dto.shop.BreadcrumbItem;
import me.alanx.ecomer.web.dto.shop.BreadcrumbItemType;
...
import me.alanx.ecomer.web.store.controller.category.facade.CategoryFacade;
import me.alanx.ecomer.web.utils.GeoLocationUtils;
    ...
    public StoreFilter() {
	   ...
	   public boolean preHandle(
			...
			try {
				...
				AnonymousCustomer anonymousCustomer =  (AnonymousCustomer)request.getSession().getAttribute(ApplicationConstants.ANONYMOUS_CUSTOMER);
				if(anonymousCustomer==null) {
					...
					try {
						...
						/*me.alanx.ecomer.core.model.common.Address geoAddress = customerService.getCustomerAddress(store, ipAddress);
						if(geoAddress!=null) {
							address = new Address();
