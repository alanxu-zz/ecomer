...
import me.alanx.ecomer.web.dto.customer.SecuredShopPersistableCustomer;
...
public class CustomerRegistrationController extends AbstractController {
	...
	public String displayRegistration(final Model model, final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		...
		AnonymousCustomer anonymousCustomer = (AnonymousCustomer)request.getAttribute(me.alanx.ecomer.core.configuration.ApplicationConstants.ANONYMOUS_CUSTOMER);
