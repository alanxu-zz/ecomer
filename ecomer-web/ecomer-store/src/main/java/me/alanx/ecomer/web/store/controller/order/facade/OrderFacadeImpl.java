...
import me.alanx.ecomer.web.dto.order.Order;
import me.alanx.ecomer.web.dto.order.OrderEntity;
import me.alanx.ecomer.web.dto.order.OrderProduct;
...
import me.alanx.ecomer.web.populator.customer.PersistableCustomerPopulator;
import me.alanx.ecomer.web.populator.order.OrderProductPopulator;
import me.alanx.ecomer.web.populator.order.ReadableOrderPopulator;
import me.alanx.ecomer.web.populator.order.ReadableOrderProductPopulator;
import me.alanx.ecomer.web.populator.order.ShoppingCartItemPopulator;
...
public class OrderFacadeImpl implements OrderFacade {
	...
	private void setOrderTotals(OrderEntity order, OrderTotalSummary summary) {
		...
		List<me.alanx.ecomer.core.model.order.OrderTotal> orderTotals = summary.getTotals();
		for(me.alanx.ecomer.core.model.order.OrderTotal t : orderTotals) {
	 ...
	 */
	@Override
	public me.alanx.ecomer.core.model.order.Order processOrder(ShopOrder order, Customer customer, MerchantStore store,
	...
	@Override
	public me.alanx.ecomer.core.model.order.Order processOrder(ShopOrder order, Customer customer, Transaction transaction, MerchantStore store,
			Language language) throws ServiceException {
	...
	private me.alanx.ecomer.core.model.order.Order processOrderModel(ShopOrder order, Customer customer, Transaction transaction, MerchantStore store,
			Language language) throws ServiceException {
		...
		try {
			...
			me.alanx.ecomer.core.model.order.Order modelOrder = new me.alanx.ecomer.core.model.order.Order();
			...
			Set<me.alanx.ecomer.core.model.order.product.OrderProduct> orderProducts = new LinkedHashSet<me.alanx.ecomer.core.model.order.product.OrderProduct>();
			...
			for(ShoppingCartItem item : shoppingCartItems) {
				me.alanx.ecomer.core.model.order.product.OrderProduct orderProduct = new me.alanx.ecomer.core.model.order.product.OrderProduct();
			...
			List<me.alanx.ecomer.core.model.order.OrderTotal> totals = summary.getTotals();

			//re-order totals
			Collections.sort(
					totals,
					new Comparator<me.alanx.ecomer.core.model.order.OrderTotal>() {
					       public int compare(me.alanx.ecomer.core.model.order.OrderTotal x, me.alanx.ecomer.core.model.order.OrderTotal y) {
			...
			Set<me.alanx.ecomer.core.model.order.OrderTotal> modelTotals = new LinkedHashSet<me.alanx.ecomer.core.model.order.OrderTotal>();
			for(me.alanx.ecomer.core.model.order.OrderTotal total : totals) {
	...
	private void orderCustomer(Customer customer, me.alanx.ecomer.core.model.order.Order order, Language language) throws Exception {
	...
	public ShippingQuote getShippingQuote(Customer customer, ShoppingCart cart,
     ...
     private ReadableOrderList populateOrderList(final OrderList orderList,final MerchantStore store, final Language language){
        List<me.alanx.ecomer.core.model.order.Order> orders = orderList.getOrders();
        ...
        for (me.alanx.ecomer.core.model.order.Order order : orders) {
    ...
    private void setOrderProductList(final me.alanx.ecomer.core.model.order.Order order, final Locale locale,final MerchantStore store, final Language language , final ReadableOrder readableOrder) throws ConversionException{
        List<ReadableOrderProduct> orderProducts = new ArrayList<ReadableOrderProduct>();
        for(me.alanx.ecomer.core.model.order.product.OrderProduct p : order.getOrderProducts()) {
	...
	public ReadableOrder getReadableOrder(Long orderId, MerchantStore store,
		...
		me.alanx.ecomer.core.model.order.Order modelOrder = orderService.getById(orderId);
		if(modelOrder==null) {
		...
		//order products
		List<ReadableOrderProduct> orderProducts = new ArrayList<ReadableOrderProduct>();
		for(me.alanx.ecomer.core.model.order.product.OrderProduct p : modelOrder.getOrderProducts()) {
			ReadableOrderProductPopulator orderProductPopulator = new ReadableOrderProductPopulator();
			orderProductPopulator.setProductService(productService);
			orderProductPopulator.setPricingService(pricingService);
			orderProductPopulator.setimageUtils(imageUtils);
