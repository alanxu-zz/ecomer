package me.alanx.ecomer.web.store.services.init;
...
import me.alanx.ecomer.core.model.customer.CustomerGender;
...
import me.alanx.ecomer.core.services.catalog.product.availability.ProductAvailabilityService;
...
import me.alanx.ecomer.core.utils.LocaleUtils;

@Component
public class DefaultStoreDataInitializer extends DefaultDatabaseInitializer{
	
	private static final Logger LOGGER = LoggerFactory.getLogger(DefaultStoreDataInitializer.class);
	...
	@Inject
	protected ProductOptionPriceService productAttributeService;
	...
	public void init() throws DataInitiationException {
		...
		try {
			if (this.productService.count() > 0) {
				LOGGER.info("Store data is not empty, skip initialization. ");
				return;
			}
			...
			ProductType generalType = productTypeService.getProductType(ProductType.GENERAL_TYPE);
			 ...
			 Category book = new Category();
			   ...
			   // productAvailabilityService.create(availability5);
				...
				//"password" - encoded by me.alanx.ecomer.web.admin.BCryptPasswordEncoder
				String password = "$2a$10$ZRf9yHeQbxeYJj98wxpsdej1IOmIEy4EGFHbO.V/Qh/txeepoXdl.";
...
//		    billing.setCountryCode(canada.getIsoCode());
			...
			throw new DataInitiationException();
		}
