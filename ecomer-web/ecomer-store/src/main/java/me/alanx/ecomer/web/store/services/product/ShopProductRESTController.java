...
import me.alanx.ecomer.web.dto.catalog.product.Product;
...
import me.alanx.ecomer.web.dto.query.QueryFilter;
import me.alanx.ecomer.web.dto.query.QueryFilterType;
import me.alanx.ecomer.web.populator.catalog.PersistableProductOptionPopulator;
import me.alanx.ecomer.web.populator.catalog.PersistableProductOptionValuePopulator;
...
import me.alanx.ecomer.web.populator.manufacturer.PersistableManufacturerPopulator;
...
public class ShopProductRESTController {
	...
	public void deleteProduct(@PathVariable final String store, @PathVariable Long id, HttpServletRequest request, HttpServletResponse response) throws Exception {
		me.alanx.ecomer.core.model.catalog.product.Product product = productService.getById(id);
...
/*	*//**
	...
	private ReadableProductList getProducts(final int start, final int max, final String store, final String language, final String category, final List<QueryFilter> filters, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			ProductList products = productService.listByStore(merchantStore, lang, productCriteria);
			...
			for(me.alanx.ecomer.core.model.catalog.product.Product product : products.getProducts()) {
