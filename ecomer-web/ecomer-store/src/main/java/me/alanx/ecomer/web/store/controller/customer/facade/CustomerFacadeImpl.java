...
import me.alanx.ecomer.web.populator.customer.CustomerBillingAddressPopulator;
import me.alanx.ecomer.web.populator.customer.CustomerDeliveryAddressPopulator;
import me.alanx.ecomer.web.populator.customer.CustomerEntityPopulator;
import me.alanx.ecomer.web.populator.customer.CustomerPopulator;
import me.alanx.ecomer.web.populator.customer.PersistableCustomerBillingAddressPopulator;
import me.alanx.ecomer.web.populator.customer.PersistableCustomerShippingAddressPopulator;
	...
	public void setCustomerModelDefaultProperties(Customer customer,
		...
		if(CollectionUtils.isEmpty(customer.getGroups())) {
			...
			for(Group group : groups) {
				  if(group.getGroupName().equals(ApplicationConstants.GROUP_CUSTOMER)) {
