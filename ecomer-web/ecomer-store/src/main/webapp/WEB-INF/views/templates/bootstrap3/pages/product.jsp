...
<script src="<c:url value="/resources/js/jquery.raty.min.js" />"></script>
            ...
            <div id="shop" class="container">
            	...
            	<jsp:include page="/WEB-INF/views/templates/bootstrap3/sections/breadcrumb.jsp" />
                ...
                <div itemscope class="col-sm-12 col-md-12 mainProductColumn" itemtype="http://data-vocabulary.org/Product">
						...
						<div class="col-sm-6 col-md-6">
							...
							<!-- product rating -->
							<jsp:include page="/WEB-INF/views/common/catalog/rating.jsp" />
							...
							<p>
								<jsp:include page="/WEB-INF/views/common/catalog/addToCartProduct.jsp" />
							</p>
						</div>
                    ...
                    <div class="row">
							...
							<div class="tab-content">
								...
								<div class="tab-pane productDescription" id="reviews">
									...
									<!-- reviews -->
									<jsp:include page="/WEB-INF/views/common/catalog/reviews.jsp" />
                        ...
                        <c:if test="${relatedProducts!=null}">	
									...
									<ul class="thumbnails product-list">
										<!-- Iterate over featuredItems -->
	                         			...
	                         			<jsp:include page="/WEB-INF/views/templates/bootstrap3/sections/productBox.jsp" />
									</ul>
						</c:if>
