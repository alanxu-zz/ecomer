...
public class RequestUtils {
	 ...
	 * @return
	 */
	public Language getLanguage(HttpServletRequest request, HttpServletResponse response) {
		...
		if (language == null) {
			...
			Locale localeFromContext = LocaleContextHolder.getLocale();// should
																		// be
																		// browser
																		// locale
	 ...
	 * @throws Exception
	 */
	public Language getLanguage(HttpServletRequest request, MerchantStore store) throws Exception {
