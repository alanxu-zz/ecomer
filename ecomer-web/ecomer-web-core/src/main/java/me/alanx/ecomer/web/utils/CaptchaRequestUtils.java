...
public class CaptchaRequestUtils {
	...
	@Autowired
	private Environment env; //for reading public and secret key
	...
	public boolean checkCaptcha(String gRecaptchaResponse) throws Exception {
	    ...
	    String url = env.getProperty(ApplicationConstants.RECAPTCHA_URL);;

        List<NameValuePair> data = new ArrayList<NameValuePair>();
        data.add(new BasicNameValuePair("secret",  env.getProperty(ApplicationConstants.RECAPTCHA_PRIVATE_KEY)));
