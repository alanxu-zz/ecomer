	...
	public Customer populate(PersistableCustomer source, Customer target,
		...
		try {
			...
			if(source.getGender()!=null && target.getGender()==null) {
				target.setGender( me.alanx.ecomer.core.model.customer.CustomerGender.valueOf( source.getGender() ) );
			}
			if(target.getGender()==null) {
				target.setGender( me.alanx.ecomer.core.model.customer.CustomerGender.M);
			}
